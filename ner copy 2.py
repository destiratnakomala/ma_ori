...
template = """# Anda Adalah Seorang Hakim Agung Di Mahkamah Agung Di Indonesia. Berdasarkan Putusan Di Bawah Ini, Berikan Kesimpulannya:
{}
...
- Template Format:
    ```
    'Nama Terdakwa', 'Usia Terdakwa', dinyatakan bersalah melanggar 'Pasal Dakwaan' berdasarkan putusan Lembaga Peradilan nomor 'Nomor Putusan Akhir' yang terdaftar pada tanggal 'Tanggal Registrasi'. Pengadilan memutuskan 'Hasil Putusan Akhir', dan menjatuhkan hukuman 'Hukuman'.
```
- Example:
    ```
    Nama Terdakwa: John Doe, usia 35, dinyatakan bersalah melanggar Pasal 340 KUHP tentang Pembunuhan Berencana berdasarkan putusan Mahkamah Agung nomor 1993 K/PID.SUS/2019 yang terdaftar pada tanggal 1 Januari 2019. Pengadilan memutuskan bersalah, dan menjatuhkan hukuman pidana penjara selama 20 tahun.
    ```
