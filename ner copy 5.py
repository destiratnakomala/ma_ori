...
## Ringkasan Perkara
### Jenis Perkara:
- Pidana/Sipil/Tata Usaha Negara: 
...
- Kronologi Kejadian: Rincian urutan kejadian terkait perkara, mulai dari insiden awal hingga sidang terakhir.
...
- Fakta-Fakta yang Terbukti: 
  - Rincian fakta-fakta yang terbukti selama persidangan, didukung oleh bukti dan kesaksian.
- Analisis Bukti: 
  - Ringkasan bagaimana bukti yang disajikan dievaluasi dan pengaruhnya terhadap putusan.
- Keterangan Saksi: 
  - Pernyataan utama yang diberikan oleh saksi yang mempengaruhi putusan.
- Barang Bukti: 
  - Daftar barang yang diajukan sebagai bukti fisik dan relevansinya.
- Pengakuan Terdakwa: 
  - Catatan mengenai pengakuan atau pengakuan bersalah dari terdakwa selama persidangan.
- Fakta-Fakta yang Tidak Terbukti: 
  - Fakta atau klaim yang tidak dapat dibuktikan oleh bukti.
  - Faktor yang memberatkan: 
  - Faktor yang meringankan: 
...
### Analisis Hukum
- Penerapan Hukum: 
  - Penjelasan tentang bagaimana hukum yang relevan diterapkan pada fakta-fakta yang terbukti dalam kasus ini.
- Pasal-Pasal yang Dilanggar: 
  - Pasal-pasal hukum yang ditemukan telah dilanggar.
- Interpretasi dan Penafsiran Hukum: 
  - Penjelasan mengenai interpretasi hukum oleh pengadilan dan alasan di balik penerapannya.
- Pertimbangan dari Putusan Sebelumnya: 
  - Referensi terhadap preseden atau putusan sebelumnya yang dipertimbangkan dalam membuat keputusan.
- Pertimbangan terhadap Argumentasi Kasasi: 
  - Pembahasan mengenai validitas argumen yang diajukan dalam kasasi dan bagaimana hal itu ditangani.

### Faktor-Faktor yang Memberatkan dan Meringankan
- Faktor-Faktor yang Memberatkan: 
  - Faktor-faktor yang menyebabkan hukuman menjadi lebih berat, seperti tingkat keparahan kejahatan atau catatan pelanggaran sebelumnya.
- Faktor-Faktor yang Meringankan: 
  - Keadaan yang dapat menyebabkan hukuman menjadi lebih ringan, seperti penyesalan terdakwa atau kerjasama dengan pihak berwenang.

## Amar Putusan
### Tuntutan Jaksa Penuntut Umum
- Jenis Hukuman yang Diminta: 
  - Rincian hukuman yang diminta oleh jaksa penuntut umum, termasuk jenis dan lamanya hukuman.
- Permintaan Tambahan: 
  - Catatan mengenai hukuman tambahan atau tindakan lain yang diminta oleh jaksa.

### Putusan Mahkamah Agung
- Jenis Hukuman yang Dijatuhkan: 
  - Deskripsi mengenai hukuman yang dijatuhkan oleh pengadilan, termasuk sifatnya (misalnya, penjara, denda) dan durasinya.
- Tindakan Tambahan yang Diperintahkan: 
  - Tindakan lain yang diperintahkan oleh pengadilan, seperti pengembalian, layanan masyarakat, atau penyitaan aset.
- Penanganan Barang Bukti: 
  - Keputusan pengadilan mengenai penyitaan atau pengembalian barang bukti.
- Biaya Perkara: 
  - Rincian mengenai pembagian biaya perkara dan sanksi finansial yang dijatuhkan.
- Hak untuk Mengajukan Banding atau Kasasi: 
  - Informasi mengenai hak terdakwa untuk mengajukan banding atau kasasi dan batas waktu untuk mengajukannya.
- Pertimbangan Kasasi: 
  - Bagaimana keputusan pengadilan menjawab argumen dan bukti yang diajukan dalam kasasi.

## Penutup
- Tanggal Putusan: 
- Komentar Terakhir Hakim: 
  - Pernyataan penutup atau komentar yang diberikan oleh hakim ketua.
- Tanda Tangan Hakim:
  - Hakim Ketua: 
  - Hakim Anggota: 
  - Panitera: 
...
### Daftar Barang Bukti
- Barang Bukti:
  - Daftar terperinci dari semua barang yang diajukan sebagai bukti, beserta deskripsinya.
  
### Transkrip dan Catatan
- Transkrip Pengadilan:
  - Ringkasan transkrip pengadilan atau kutipan penting dari persidangan.
  
### Dokumentasi Tambahan
- Dokumen Terkait:
  - Dokumen tambahan atau referensi hukum lainnya yang menjadi bagian dari berkas perkara.
...
- Template Format:
    ```
    Terdakwa bernama 'Nama Terdakwa', usia 'Usia Terdakwa', dinyatakan bersalah melanggar 'Pasal Dakwaan', dituntut oleh 'lembaga putusan' total selama 'berapa tahun'  berdasarkan putusan 'Lembaga Peradilan' nomor 'Nomor Putusan Akhir' yang terdaftar pada tanggal 'Tanggal Registrasi'. Pengadilan memutuskan 'Hasil Putusan Akhir', dan menjatuhkan hukuman 'Hukuman'.'
    ```
- Example:
    ```
