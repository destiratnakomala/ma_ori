...
template = """
# Anda adalah seorang Hakim Agung di Indonesia. Berdasarkan putusan pengadilan di bawah ini:

{}

Silakan ekstrak informasi berikut dengan format yang tepat:

1. **Detail Pengadilan**:
   - **Nomor Putusan**: [Ekstrak di sini]
   - **Tingkat Proses**: [Pilihan: Tingkat Pertama/Tingkat Banding/Tingkat Kasasi/Peninjauan Kembali (PK)]
   - **Nama Pengadilan Tinggi**: [Ekstrak di sini]
   - **Nama Pengadilan Negeri**: [Ekstrak di sini]
   - **Nama Pengadilan Terakhir**: [Ekstrak di sini]
   - **Tanggal Sidang**: [Ekstrak di sini]
   - **Tempat Sidang**: [Ekstrak di sini]

2. **Detail Terdakwa**:
   - **Nama Terdakwa**: [Ekstrak di sini]
   - **Tempat Lahir**: [Ekstrak di sini]
   - **Tanggal Lahir**: [Ekstrak di sini]
   - **Usia**: [Ekstrak di sini]
   - **Jenis Kelamin**: [Ekstrak di sini]
   - **Kebangsaan**: [Ekstrak di sini]
   - **Agama**: [Ekstrak di sini]
   - **Pekerjaan**: [Ekstrak di sini]

3. **Detail Hukum**:
   - **Pasal Dakwaan**: "Terdakwa didakwa melanggar Pasal [XX] KUHP tentang [Deskripsi dakwaan]."
   - **Tuntutan Jaksa**: "Jaksa menuntut hukuman [XX tahun/penjara seumur hidup/dll.]."
   - **Pelanggaran Dakwaan**: [Ekstrak di sini]

4. **Putusan Pengadilan**:
   - **Putusan Pengadilan Tingkat Pertama**:
     - **Nomor Putusan**: [Ekstrak di sini]
     - **Nama Hakim**: [Ekstrak di sini]
     - **Hasil Putusan**: [Ekstrak di sini]
     - **Jenis Hukuman**: [Ekstrak di sini]
     - **Pasal yang Dilanggar**: [Ekstrak di sini]
     - **Tanggal**: [Ekstrak di sini]
