...
- Pasal Dakwaan
- Pelanggaran Dakwaan
- Timeline: Berikan list tanggal, nomor putusan, dan hasil dari awal hingga akhir putusan
- Timeline Hasil Putusan:
...
- Putusan Hakim: Uraikan putusan yang dijatuhkan oleh hakim, termasuk pertimbangan hukum yang mendasari putusan tersebut. Contoh: "Hakim menjatuhkan pidana penjara selama 20 tahun dengan mempertimbangkan bahwa terdakwa menunjukkan penyesalan."
...
- Template Format:
    ```
    Berikut adalah timeline 'nomor putusan' untuk terdakwa bernama 'nama terdakwa': 
    1. Pada tanggal ...
    2. Pada tanggal ...
    3. Pada tanggal ...
    4. Pada tanggal ...
...
- Example:
    ...
    ```
Tambahan: 
Hasil harus selalu konsisten, jika tidak ada datanya tulis "Tidak Ada Informasi"
Jika Hasilnya ada Biaya Perkara maka TIDAK PERLU DITULISKAN
